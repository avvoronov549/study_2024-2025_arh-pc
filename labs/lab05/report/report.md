...
Ввожу соответствующую  комманду в терминале (рис. -@fig:001), открываю Midnight Commander (рис. -@fig:002).

![Отркрытие Midnight Commander](image/1.png){#fig:001 width=70%}

![Интерфейс Midnight Commander](image/2.png){#fig:002 width=70%}

Перехожу в созданный каталог в предыдущей лабораторной работе 4 (рис. -@fig:003).
